...
Private Sub lblCancelar_Click()
    ...
    If MsgBox("Confirma o Cancelamento ?", vbQuestion + vbYesNo, "Confirme !") = vbYes Then
      Set vop_ComandasNegocios = New clsComandasNegocios
          vop_ComandasNegocios.IdComanda = vil_IdComanda
          If vop_ComandasNegocios.ExcluirComandas() = True Then
...
On Error GoTo TrataErros
    ...
    Set vop_ComandasNegocios = New clsComandasNegocios
        ...
        vbl_Carregar = vop_ComandasNegocios.CarregarGridComandaRS(adoComandas, frmComandasLista.txtLocalizarComanda.text, IIf(frmComandasLista.cmbLocalizarComanda.ListIndex < 0, 0, frmComandasLista.cmbLocalizarComanda.ListIndex), adoItensComanda, frmComandasLista.txtLocalizarItem.text, IIf(frmComandasLista.cmbLocalizarItem.ListIndex < 0, 0, frmComandasLista.cmbLocalizarItem.ListIndex))
