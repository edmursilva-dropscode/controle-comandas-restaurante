...
Begin VB.Form frmTiposComandas 
   ...
   Begin LVbuttons.LaVolpeButton lblGravar 
      ...
      EMBOSSS         =   16777215
      MPTR            =   0
      MICON           =   "frmTiposComandas.frx":0000
      ALIGN           =   1
      IMGLST          =   "(None)"
      IMGICON         =   "(None)"
      ICONAlign       =   0
   ...
   Begin LVbuttons.LaVolpeButton lvbFechar 
      ...
      EMBOSSS         =   16777215
      MPTR            =   0
      MICON           =   "frmTiposComandas.frx":001C
      ALIGN           =   1
      IMGLST          =   "(None)"
      IMGICON         =   "(None)"
      ICONAlign       =   0
   ...
   Begin VB.Image imgLinha 
      Height          =   45
      Left            =   -1755
      Picture         =   "frmTiposComandas.frx":0038
      Top             =   630
      Width           =   10740
   End
   Begin VB.Image imgIcone 
      Height          =   480
      Left            =   105
      Picture         =   "frmTiposComandas.frx":09BC
      Top             =   60
      Width           =   480
   End
   ...
   End
End
Attribute VB_Name = "frmTiposComandas"
...
Dim vsp_Mensagem As String
   ...
   If MsgBox(vsp_Mensagem, vbQuestion + vbYesNo, "Confirme !") = vbYes Then
      ...
      Set vop_TiposComandasNegocios = New clsTiposComandasNegocios
          vop_TiposComandasNegocios.IdComanda = lblCodigo.Caption
          vop_TiposComandasNegocios.Descricao = txtDescricao.text
          If vbp_Comanda = False Then
             If vop_TiposComandasNegocios.IncluirTipoComanda() = True Then
                MsgBox "Comanda cadastrada com sucesso !", vbExclamation, "Comanda"
             End If
          Else
             If vop_TiposComandasNegocios.AlterarTipoComanda() = True Then
   ...
   'Atualiza grid
   Call frmTiposComandasLista.CarregarGrid
   
   'Inicializa entrada e saida
   Call InicializaEntradaSaida
   
   'Valida entrada de dados
   If vbp_Comanda = True Then
...
Function Editar(ByVal pIdcomanda As Integer) As Boolean
    ...
    Set vop_TiposComandasNegocios = New clsTiposComandasNegocios
        ...
        If vop_TiposComandasNegocios.PesquisarTipoComanda(lvwTiposComandas, pIdcomanda, 0) = True Then
           lblCodigo.Caption = pIdcomanda
           txtDescricao.text = vop_TiposComandasNegocios.Descricao
        Else
...
Function VerCampos() As Boolean
    ...
    If Trim$(txtDescricao.text) = Empty Then
        MsgBox "Informe a descrição da Comanda !", vbExclamation, "Comanda"
