...
Begin VB.Form frmEstatisticaItensLista 
   ...
   Begin prjXTab.XTab xtbDevolucao 
      ...
      _ExtentY        =   12250
      TabCount        =   1
      TabCaption(0)   =   "   Estatisticas  "
      TabContCtrlCnt(0)=   4
      Tab(0)ContCtrlCap(1)=   "dtgEstatisticaItensDias"
      Tab(0)ContCtrlCap(2)=   "cmbLocalizarItemEstatistica"
      Tab(0)ContCtrlCap(3)=   "dtgEstatisticaItens"
      ...
      Begin MSDataGridLib.DataGrid dtgEstatisticaItensDias 
         Bindings        =   "frmEstatisticaItensLista.frx":0000
         Height          =   6435
         Left            =   105
         TabIndex        =   13
         Top             =   390
      ...
      Begin VB.ComboBox cmbLocalizarItemEstatistica 
         Height          =   315
         ItemData        =   "frmEstatisticaItensLista.frx":0026
         Left            =   5280
         List            =   "frmEstatisticaItensLista.frx":0033
         TabIndex        =   11
         Top             =   -15
         Width           =   4020
      End
      Begin MSDataGridLib.DataGrid dtgEstatisticaItens 
         Bindings        =   "frmEstatisticaItensLista.frx":00B5
         Height          =   6435
         Left            =   105
         TabIndex        =   9
         Top             =   390
      ...
      Begin LVbuttons.LaVolpeButton lvbRemoverDevolucao 
         ...
         EMBOSSS         =   16777215
         MPTR            =   0
         MICON           =   "frmEstatisticaItensLista.frx":00D7
         ALIGN           =   1
         IMGLST          =   "(None)"
         IMGICON         =   "(None)"
         ICONAlign       =   0
      ...
      Begin LVbuttons.LaVolpeButton lvbEditarDevolucao 
         ...
         EMBOSSS         =   16777215
         MPTR            =   0
         MICON           =   "frmEstatisticaItensLista.frx":00F3
         ALIGN           =   1
         IMGLST          =   "(None)"
         IMGICON         =   "(None)"
         ICONAlign       =   0
   ...
   Begin LVbuttons.LaVolpeButton lblFechar 
      ...
      EMBOSSS         =   16777215
      MPTR            =   0
      MICON           =   "frmEstatisticaItensLista.frx":010F
      ALIGN           =   1
      IMGLST          =   "(None)"
      IMGICON         =   "(None)"
      ICONAlign       =   0
   ...
   Begin MSAdodcLib.Adodc adoEstatisticaItens 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   $"frmEstatisticaItensLista.frx":012B
   ...
   Begin LVbuttons.LaVolpeButton lblImprimir 
      ...
      EMBOSSS         =   16777215
      MPTR            =   0
      MICON           =   "frmEstatisticaItensLista.frx":0457
      ALIGN           =   1
      IMGLST          =   "(None)"
      IMGICON         =   "(None)"
      ICONAlign       =   0
   ...
   Begin MSAdodcLib.Adodc adoEstatisticaItensDias 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   $"frmEstatisticaItensLista.frx":0473
   ...
   Begin VB.Image Image2 
      Height          =   480
      Left            =   75
      Picture         =   "frmEstatisticaItensLista.frx":07A1
      Top             =   75
      Width           =   480
   End
   Begin VB.Image Image1 
      Height          =   45
      Left            =   9210
      Picture         =   "frmEstatisticaItensLista.frx":106B
      Top             =   675
      Width           =   10740
   End
   Begin VB.Image imgLinha 
      Height          =   45
      Left            =   -1200
      Picture         =   "frmEstatisticaItensLista.frx":19EF
      Top             =   675
      Width           =   10740
   End
   Begin VB.Label lblTitulo 
